...
# global u 
class Polygon:
    def __init__(self, sides, color, x_offset, y_offset, offset_rotation, length=15):
        self.sides = sides
...
#     global board
#     board = main.UnitGrid(width, height)
#     graphics.drawUnitGrid(board)
start(20,20)