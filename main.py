...
class S2(Square):
	def __init__(self):
		super().__init__(0, 1 + math.sqrt(3), 0, 60)

class S3(Square):
	def __init__(self):
		super().__init__(0, 1.5+math.sqrt(3)/2,-1.5-math.sqrt(3)/2, 30)

class S4(Square):
	def __init__(self):
		super().__init__(0, 0, -2-math.sqrt(3), 0)

class S5(Square):
	def __init__(self):
		super().__init__(0, -math.sqrt(3)/2, -1.5-math.sqrt(3), 150)

class S6(Square):
	def __init__(self):
		super().__init__(0, -.5-math.sqrt(3)/2, -.5-math.sqrt(3)/2, 210)
...
class T1(Triangle):
	def __init__(self):
		super().__init__(0, 1+math.sqrt(3), 0, 0)
...
class H1(Hexagon):
	def __init__(self):
		super().__init__(0, 1+math.sqrt(3)/2,  1.5, 30)

class H2(Hexagon):
	def __init__(self):
		super().__init__(0, 1.5 + math.sqrt(3),  -math.sqrt(3)/2, 30)

class H3(Hexagon):
	def __init__(self):
		super().__init__(0, 1+math.sqrt(3)/2,  -1.5-math.sqrt(3), 30)
